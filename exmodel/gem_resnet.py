...
"""
    This is the ResNet used by Lopez et al. in the GEM paper.
    see https://github.com/facebookresearch/GradientEpisodicMemory/blob/master/model/common.py
...
from exmodel.models.masking import MultiTaskMasking
...
class MTMaskedResNet18(MTResNet18):
    def __init__(self, nclasses, nf=20):
